...
export default function Home() {
  ...
  const featuredEvents =
    events?.filter((e) => e.isFeatured).slice(0, 3) || events?.slice(0, 3);
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="container relative z-10 px-4 text-center">
          <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-10 font-medium leading-relaxed">
              Find and buy tickets for the best shows and parties in Nigeria.
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link href="/calendar">
                <div className="flex flex-col items-center gap-2 w-full sm:w-auto">
                  <Button
                    variant="outline"
                    className="w-full sm:w-auto h-16 px-10 rounded-2xl text-lg font-bold border-white/20 text-white hover:bg-white/10 backdrop-blur-sm"
                  >
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Black Heritage Events & Entertainment is the best place to find
              tickets for the coolest shows and parties. We bring you the fun
              you deserve without any stress.
            </p>
            <Link href="/events">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/5]">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-6 bg-white/5 backdrop-blur-md rounded-xl border border-white/10">
                <p className="text-white italic text-lg font-display">
                  "An absolute triumph of culture and class. The best event I've
                  attended all year."
                </p>
      ...
      <footer className="py-12 bg-background border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold font-display mb-2 text-white uppercase">
            Black Heritage
          </h2>
          ...
          <p className="text-sm text-white/20">
            © {new Date().getFullYear()} Black Heritage. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
