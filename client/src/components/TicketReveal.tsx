...
import { CalendarPlus, Check, Copy, MessageCircle, PartyPopper } from "lucide-react";
import {
  Dialog,
  DialogContent,
        ...
        <div className="p-7 space-y-6">
          ...
          >
            <Button
              asChild
              variant="outline"
              className="press h-12 border-hairline text-ink hover:bg-surface-2 font-medium rounded-md"
            >
              <a
            ...
            <Button
              asChild
              className="press h-12 bg-primary text-primary-foreground hover:bg-gold-soft font-medium rounded-md"
            >
              <a
